...
export const productBySkuQuery = groq`
  *[_type == "product" && slug.current == $sku][0] {
    ...
    specs,
    compliance,
    "datasheet": datasheet->{ title_en, title_th, fileSize, "url": file.asset->url },
    "wiringDiagram": wiringDiagram->{ title_en, title_th, fileSize, "url": file.asset->url },
    "installManual": installManual->{ title_en, title_th, fileSize, "url": file.asset->url },
    "brand": brand->{
      _id,
      name,
      "slug": slug.current,
